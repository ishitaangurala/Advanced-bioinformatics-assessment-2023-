...
#changing the aligner to bowtie2
cd ~/ngs_assessment/dnaseq/data
bowtie2-build ~/ngs_assessment/dnaseq/data/reference/hg19.fa ~/ngs_assessment/dnaseq/data/reference/bowtieindexhg19

bowtie2 --no-unal -x ~/ngs_assessment/dnaseq/data/reference/bowtieindexhg19 -1 ~/ngs_assessment/dnaseq/data/trimmed_fastq/NGS0001_trimmed_R_1P -2 ~/ngs_assessment/dnaseq/data/trimmed_fastq/NGS0001_trimmed_R_2P -S ~/ngs_assessment/dnaseq/data/aligned_data/NGS0001.sam
